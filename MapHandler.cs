...
namespace RogueMaker
{
    public class MapHandler
    {
        public MapObject LoadMap(string filePath)
        {
            ...
            {
                Console.WriteLine("* [ERROR] There was a problem loading the map. If it's old map - try to update version of the map by saving it in-game, and parse again");
        ...
        public void SaveMap(MapObject mapObject, string targetFilePath)
        {
            ...
            {
                Console.WriteLine("* [ERROR] There was a problem saving the map.");
